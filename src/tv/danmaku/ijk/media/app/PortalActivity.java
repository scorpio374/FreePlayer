...
public class PortalActivity extends FragmentActivity implements OnCheckedChangeListener{
	...
	private void initView(){
		...
		mTabHost.addTab(mTabHost.newTabSpec("channel").setIndicator("Channel"),ChannelFragment.class,null);
		mTabHost.addTab(mTabHost.newTabSpec("find").setIndicator("Find"),FindFragment.class,null);
		mTabHost.addTab(mTabHost.newTabSpec("my").setIndicator("My"),MyFragment.class,null);
	...
	public void onCheckedChanged(RadioGroup group, int checkedId) {
		...
		ChannelFragment channel = (ChannelFragment) (fm.findFragmentByTag("channel"));
